...
System.out.print("Enter Name : ");
            this.name = sc.nextLine().trim();
                ...
                try {
                    ...
                    // FIXED: add the missing operator
                    if (age < 18 || age > 60) {
                        System.out.println("Age must be between 18 and 60. Please try again.");
                        continue;
                    }
                    break;
                } catch (NumberFormatException nfe) {
                    System.out.println("Age must be numeric. Please try again.");
                }
            }
                ...
                if (!line.isEmpty()) {
                    char g = Character.toUpperCase(line.charAt(0));
                    if (g == 'M' || g == 'F') {
                        this.gender = (g == 'M') ? Gender.MALE : Gender.FEMALE;
                        break;
                    }
                }
